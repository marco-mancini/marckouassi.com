...
```text
Backend/              Réservé à une future API
Deploy/               Notes sur la publication
Design_System/        CSS, tokens, animations, composants et ressources
Docs/                 Documentation éditoriale
Frontend/             Page et interactions du site
Public/images/        Emplacement des visuels locaux
.github/workflows/    Workflow Pages (emplacement requis par GitHub)
```
